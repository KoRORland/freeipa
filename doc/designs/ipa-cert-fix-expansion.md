...
::
    ...
    ipaserver/install/
        ...
        certfix/
            ...
            _constants.py            # CertIdentity, DOGTAG_CERTS, timeouts
            _types.py                # enums, CertFixContext
            _helpers.py              # stateless utility functions
            _certmonger.py           # CertmongerClient
            _classification.py       # expired_dogtag_certs, expired_ipa_certs
            _detection.py            # DeploymentDetector
            _external.py             # ExternalCertHandler
            _renewal.py              # CertRenewalFromMaster
            _certops.py              # pki-server helpers, LDAP replication
            _cli.py                  # IPACertFix AdminTool
